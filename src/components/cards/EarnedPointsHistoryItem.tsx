/**
 * Earned points history item component
 */

import React from 'react';
import GradientCard from '@/components/cards/GradientCard';
import PointsBadge from '@/components/cards/PointsBadge';
import { EarnedPointsHistory } from '@/types';

interface EarnedPointsHistoryItemProps {
  item: EarnedPointsHistory;
  gradientClass: string;
}

export default function EarnedPointsHistoryItem({
  item,
  gradientClass,
}: EarnedPointsHistoryItemProps) {
  return (
